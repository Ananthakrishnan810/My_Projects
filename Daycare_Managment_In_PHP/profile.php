    ...
    <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-7">
            ...
            <div class="card p-3 py-4">
                <?php
                 $id=$_SESSION['id'];
                 $s="select img from image where sid='$id'";
                ...
                <div class="text-center mt-3">
                    ...
                    <div class="px-4 mt-1">
                        <p class="fonts"><h6>Date-Of-Birth:<?php echo $row['dob'] ?>,Address:<?php echo $row['addres']; ?>Phone:<?php echo $row['phno'];?></h6> </p>
                    ...
                    <div class="buttons">
                        ...
                        <a href='add.php'><button class="btn btn-outline-primary px-4">Add Photo</button></a>
                        <a href='edit.php'><button class="btn btn-primary px-4 ms-3">Edit profile</button></a>
                    </div>
