...
<script>
  ...
  var fn = document.forms["mform"]["father"].value;
  var m = document.forms["mform"]["mother"].value;
  var a = document.forms["mform"]["add"].value;
  var d = document.forms["mform"]["date"].value;
  var p = document.forms["mform"]["phone"].value;
  var e = document.forms["mform"]["email"].value;
  var pa = document.forms["mform"]["pass"].value;
  var re = document.forms["mform"]["repass"].value;
  var c = document.forms["mform"]["cert"].value;
  if (f == "") {
...
<center><input type="text" name="firstname"  placeholder= "Firstname" size="15" id="a"  autocomplete="off"/></center>
      ...
      <div class="cd">
        ...
        <br>
      <center><input type="text" name="father" placeholder="fathername" size="10" id="d"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="ab">
        <!--<label id="am">
        ...
        <br>
      <center><input type="text" name="mother" placeholder="mothername" size="10" id="e"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="cd">
      <!--<label id="pm"> Address: </label>-->
        <br>
      <center><input type="text"   placeholder="Address" size="15" name="add"  id="f"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="ab">
        <!--<label id="am">Date of Brith</label>-->
        <br>
      <center><input type="Date"  name="date"  id="g"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="cd">
   <!--<label id="pm">
      Phone :
        ...
        <br>
      <center><input type="text" name="phone"  placeholder="phone no." size="10" id="h"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="ab">
  <!--<label for="email" id="am">Email</label>-->
        <br>
      <center><input type="text" placeholder="Enter Email" name="email" id="i"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="cd">
      <!--<label id="pm">
        ...
        <br>
      <center><input type="text" name="pass" placeholder="Password" size="10" id="j"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="ab">
        <!--<label id="am">
        ...
        <br>
      <center><input type="text" name="repass" placeholder="Re-Enter-Password" size="10" id="k"  autocomplete="off"/></center>
        <br>
      </div>
      <div class="cd">
      <!--<label id="pm">Gender</label>-->
          <br>
          <select name="cert" id="select">
              <option >Male</option>
     ...
     <br>    
     <h5 id="fc"><a href="staff.php">If you are a staff,Please Use this link to register</h5>
      <br>
      <br>
...
if($password == $repass)
{
  $s="insert into signup(firstname,middlename,lastname,fathername,mothername,addres,dob,phno,email,password,gender) values ('$firstname','$middlename','$lastname','$fathername','$mothername','$address','$date','$phone','$email','$password','$gender')";
    mysqli_query($con,$s);
}
else
{
