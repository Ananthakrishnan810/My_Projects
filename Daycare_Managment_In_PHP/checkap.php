  ...
  <div class="container">
    <div class="jumotron">
      ...
      <div class="card-body">
        ...
        <?php
          $sql= "select firstname,middlename,lastname,phno,addres,sid,date,time from signup ,appointment  where appointment.sid = signup.id and status='nothing' ";
            ...
            echo "<table class='table table-hover'>";
              ...
              if (isset($_POST['approve']))
              {
                 $remark = $_POST['remark'];
                 $sample = $_POST['sample'];
                 $sql="UPDATE appointment SET remark='$remark',status='approved' WHERE sid='$sample'";
              ...
              if (isset($_POST['napprove']))
              {
                 $remark = $_POST['remark'];
                 $sample = $_POST['sample'];
                 $sql="UPDATE appointment SET remark='$remark',status='rejected' WHERE sid='$sample'";
                 $res=mysqli_query($con,$sql);
                 if($res>0)
                 {
                    echo "<script type='text/javascript'>";
